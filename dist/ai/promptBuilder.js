...
- Usar exatamente: R$ ${precoFormatado}
...
Peso: ${produto.peso ? `${produto.peso}kg` : "Não informado"}
...
BULLETS:
- No máximo 4 bullets, até 15 palavras cada
- Foco em benefício prático
- Cada bullet DEVE começar obrigatoriamente com verbo no infinitivo
Exemplo correto:
